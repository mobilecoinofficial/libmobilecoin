...
public struct ConsensusConfig_ActiveMintConfig: Sendable {
  ...
  public var mintConfig: External_MintConfig {
    get {_mintConfig ?? External_MintConfig()}
    set {_mintConfig = newValue}
  }
  /// Returns true if `mintConfig` has been explicitly set.
  public var hasMintConfig: Bool {self._mintConfig != nil}
...
public struct ConsensusConfig_ActiveMintConfigs: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct ConsensusConfig_TokenConfig: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var governors: External_Ed25519SignerSet {
    get {_governors ?? External_Ed25519SignerSet()}
    set {_governors = newValue}
  }
  /// Returns true if `governors` has been explicitly set.
  public var hasGovernors: Bool {self._governors != nil}
  ...
  public var activeMintConfigs: ConsensusConfig_ActiveMintConfigs {
    get {_activeMintConfigs ?? ConsensusConfig_ActiveMintConfigs()}
    set {_activeMintConfigs = newValue}
  }
  /// Returns true if `activeMintConfigs` has been explicitly set.
  public var hasActiveMintConfigs: Bool {self._activeMintConfigs != nil}
...
public struct ConsensusConfig_ConsensusNodeConfig: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var mintingTrustRoot: External_Ed25519Public {
    get {_mintingTrustRoot ?? External_Ed25519Public()}
    set {_mintingTrustRoot = newValue}
  }
  /// Returns true if `mintingTrustRoot` has been explicitly set.
  public var hasMintingTrustRoot: Bool {self._mintingTrustRoot != nil}
  ...
  public var governorsSignature: External_Ed25519Signature {
    get {_governorsSignature ?? External_Ed25519Signature()}
    set {_governorsSignature = newValue}
  }
  /// Returns true if `governorsSignature` has been explicitly set.
  public var hasGovernorsSignature: Bool {self._governorsSignature != nil}
  ...
  public var blockSigningKey: External_Ed25519Public {
    get {_blockSigningKey ?? External_Ed25519Public()}
    set {_blockSigningKey = newValue}
  }
  /// Returns true if `blockSigningKey` has been explicitly set.
  public var hasBlockSigningKey: Bool {self._blockSigningKey != nil}
  ...
  public var scpMessageSigningKey: External_Ed25519Public {
    get {_scpMessageSigningKey ?? External_Ed25519Public()}
    set {_scpMessageSigningKey = newValue}
  }
  /// Returns true if `scpMessageSigningKey` has been explicitly set.
  public var hasScpMessageSigningKey: Bool {self._scpMessageSigningKey != nil}
...
extension ConsensusConfig_ActiveMintConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}mint_config\0\u{3}total_minted\0")
...
extension ConsensusConfig_ActiveMintConfigs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}configs\0\u{3}mint_config_tx\0")
...
extension ConsensusConfig_TokenConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}token_id\0\u{3}minimum_fee\0\u{1}governors\0\u{3}active_mint_configs\0")
...
extension ConsensusConfig_ConsensusNodeConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}minting_trust_root\0\u{3}token_config_map\0\u{3}governors_signature\0\u{3}peer_responder_id\0\u{3}client_responder_id\0\u{3}block_signing_key\0\u{3}block_version\0\u{3}scp_message_signing_key\0")
