...
public enum ConsensusCommon_ProposeTxResult: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public struct ConsensusCommon_LastBlockInfoResponse: Sendable {
...
public struct ConsensusCommon_BlocksRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct ConsensusCommon_BlocksResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct ConsensusCommon_ProposeTxResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension ConsensusCommon_ProposeTxResult: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0Ok\0\u{2}\u{a}InputsProofsLengthMismatch\0\u{1}NoInputs\0\u{1}TooManyInputs\0\u{1}InsufficientInputSignatures\0\u{1}InvalidInputSignature\0\u{1}InvalidTransactionSignature\0\u{1}InvalidRangeProof\0\u{1}InsufficientRingSize\0\u{1}TombstoneBlockExceeded\0\u{1}TombstoneBlockTooFar\0\u{1}NoOutputs\0\u{1}TooManyOutputs\0\u{1}ExcessiveRingSize\0\u{1}DuplicateRingElements\0\u{1}UnsortedRingElements\0\u{1}UnequalRingSizes\0\u{1}UnsortedKeyImages\0\u{1}ContainsSpentKeyImage\0\u{1}DuplicateKeyImages\0\u{1}DuplicateOutputPublicKey\0\u{1}ContainsExistingOutputPublicKey\0\u{1}MissingTxOutMembershipProof\0\u{1}InvalidTxOutMembershipProof\0\u{1}InvalidRistrettoPublicKey\0\u{1}InvalidLedgerContext\0\u{1}Ledger\0\u{1}MembershipProofValidationError\0\u{1}TxFeeError\0\u{1}KeyError\0\u{1}UnsortedInputs\0\u{1}MissingMemo\0\u{1}MemosNotAllowed\0\u{1}TokenNotYetConfigured\0\u{1}MissingMaskedTokenId\0\u{1}MaskedTokenIdNotAllowed\0\u{1}UnsortedOutputs\0\u{1}InputRulesNotAllowed\0\u{1}InputRuleMissingRequiredOutput\0\u{1}InputRuleMaxTombstoneBlockExceeded\0\u{1}UnknownMaskedAmountVersion\0\u{1}InputRulePartialFill\0\u{1}InputRuleInvalidAmountSharedSecret\0\u{1}InputRuleTxOutConversion\0\u{1}InputRuleAmount\0\u{1}LedgerTxOutIndexOutOfBounds\0\u{1}FeeMapDigestMismatch\0")
}
...
extension ConsensusCommon_LastBlockInfoResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}index\0\u{3}mob_minimum_fee\0\u{3}minimum_fees\0\u{3}network_block_version\0")
...
extension ConsensusCommon_ProposeTxResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}result\0\u{3}block_count\0\u{3}block_version\0\u{3}err_msg\0")
