...
public enum Watcher_TimestampResultCode: SwiftProtobuf.Enum, Swift.CaseIterable {
...
extension Watcher_TimestampResultCode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UnusedField\0\u{1}TimestampFound\0\u{1}WatcherBehind\0\u{1}Unavailable\0\u{1}WatcherDatabaseError\0\u{1}BlockIndexOutOfBounds\0")
}
