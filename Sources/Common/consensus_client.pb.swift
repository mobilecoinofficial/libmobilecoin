...
public enum ConsensusClient_MintValidationResultCode: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public struct ConsensusClient_MintValidationResult: Sendable {
...
public struct ConsensusClient_ProposeMintConfigTxResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var result: ConsensusClient_MintValidationResult {
    get {_result ?? ConsensusClient_MintValidationResult()}
...
public struct ConsensusClient_ProposeMintTxResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension ConsensusClient_MintValidationResultCode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0Ok\0\u{1}InvalidBlockVersion\0\u{1}InvalidTokenId\0\u{1}InvalidNonceLength\0\u{1}InvalidSignerSet\0\u{1}InvalidSignature\0\u{1}TombstoneBlockExceeded\0\u{1}TombstoneBlockTooFar\0\u{1}Unknown\0\u{1}AmountExceedsMintLimit\0\u{1}NoGovernors\0\u{1}NonceAlreadyUsed\0\u{1}NoMatchingMintConfig\0\u{1}MintingToFogNotSupported\0")
}
...
extension ConsensusClient_MintValidationResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}code\0\u{3}block_version\0\u{3}token_id\0\u{3}nonce_length\0")
...
extension ConsensusClient_ProposeMintConfigTxResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}result\0\u{3}block_count\0\u{3}block_version\0")
