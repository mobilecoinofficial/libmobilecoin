...
/// Block ID.
public struct Blockchain_BlockID: Sendable {
...
public struct Blockchain_BlockContentsHash: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Blockchain_Block: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var parentID: Blockchain_BlockID {
    get {_parentID ?? Blockchain_BlockID()}
  ...
  public var rootElement: External_TxOutMembershipElement {
    get {_rootElement ?? External_TxOutMembershipElement()}
    set {_rootElement = newValue}
  }
  /// Returns true if `rootElement` has been explicitly set.
  public var hasRootElement: Bool {self._rootElement != nil}
  ...
  public var contentsHash: Blockchain_BlockContentsHash {
    get {_contentsHash ?? Blockchain_BlockContentsHash()}
    set {_contentsHash = newValue}
  }
  /// Returns true if `contentsHash` has been explicitly set.
  public var hasContentsHash: Bool {self._contentsHash != nil}
...
public struct Blockchain_BlockContents: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Blockchain_BlockSignature: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var signature: External_Ed25519Signature {
    get {_signature ?? External_Ed25519Signature()}
  ...
  public var signer: External_Ed25519Public {
    get {_signer ?? External_Ed25519Public()}
...
public struct Blockchain_BlockMetadataContents: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var blockID: Blockchain_BlockID {
    get {_blockID ?? Blockchain_BlockID()}
  ...
  public var quorumSet: QuorumSet_QuorumSet {
    get {_quorumSet ?? QuorumSet_QuorumSet()}
    set {_quorumSet = newValue}
  }
  /// Returns true if `quorumSet` has been explicitly set.
  public var hasQuorumSet: Bool {self._quorumSet != nil}
...
public struct Blockchain_BlockMetadata: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var contents: Blockchain_BlockMetadataContents {
    get {_storage._contents ?? Blockchain_BlockMetadataContents()}
    set {_uniqueStorage()._contents = newValue}
  }
  /// Returns true if `contents` has been explicitly set.
  public var hasContents: Bool {_storage._contents != nil}
  ...
  public var nodeKey: External_Ed25519Public {
    get {_storage._nodeKey ?? External_Ed25519Public()}
    set {_uniqueStorage()._nodeKey = newValue}
  }
  /// Returns true if `nodeKey` has been explicitly set.
  public var hasNodeKey: Bool {_storage._nodeKey != nil}
  ...
  public var signature: External_Ed25519Signature {
    get {_storage._signature ?? External_Ed25519Signature()}
...
public struct Blockchain_ArchiveBlockV1: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var block: Blockchain_Block {
    get {_storage._block ?? Blockchain_Block()}
  ...
  public var blockContents: Blockchain_BlockContents {
    get {_storage._blockContents ?? Blockchain_BlockContents()}
    set {_uniqueStorage()._blockContents = newValue}
  }
  /// Returns true if `blockContents` has been explicitly set.
  public var hasBlockContents: Bool {_storage._blockContents != nil}
  ...
  public var signature: Blockchain_BlockSignature {
    get {_storage._signature ?? Blockchain_BlockSignature()}
    set {_uniqueStorage()._signature = newValue}
  }
  /// Returns true if `signature` has been explicitly set.
  public var hasSignature: Bool {_storage._signature != nil}
  ...
  public var metadata: Blockchain_BlockMetadata {
    get {_storage._metadata ?? Blockchain_BlockMetadata()}
...
/// An archived block.
public struct Blockchain_ArchiveBlock: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_Block: Equatable, Sendable {
...
public struct Blockchain_ArchiveBlocks: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Blockchain_Block: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}version\0\u{3}parent_id\0\u{1}index\0\u{3}cumulative_txo_count\0\u{3}root_element\0\u{3}contents_hash\0")
...
extension Blockchain_BlockContents: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}key_images\0\u{1}outputs\0\u{3}validated_mint_config_txs\0\u{3}mint_txs\0")
...
extension Blockchain_BlockSignature: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}signature\0\u{1}signer\0\u{3}signed_at\0")
...
extension Blockchain_BlockMetadataContents: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}block_id\0\u{3}quorum_set\0\u{3}verification_report\0\u{3}responder_id\0\u{3}dcap_evidence\0")
...
extension Blockchain_BlockMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}contents\0\u{3}node_key\0\u{1}signature\0")
...
extension Blockchain_ArchiveBlockV1: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}block\0\u{3}block_contents\0\u{1}signature\0\u{1}metadata\0")
