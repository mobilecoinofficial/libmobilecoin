...
public enum MistyswapOnramp_OnrampResultCode: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public enum MistyswapOnramp_OnrampState: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case osInvalid // = 0
  case osNotStarted // = 1
  case osPolling // = 2
...
public struct MistyswapOnramp_OnrampResult: Sendable {
...
public struct MistyswapOnramp_OnrampParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct MistyswapOnramp_SetupOnrampRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var params: MistyswapOnramp_OnrampParams {
    get {_params ?? MistyswapOnramp_OnrampParams()}
...
public struct MistyswapOnramp_SetupOnrampResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var result: MistyswapOnramp_OnrampResult {
    get {_result ?? MistyswapOnramp_OnrampResult()}
...
public struct MistyswapOnramp_ForgetOnrampRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct MistyswapOnramp_ForgetOnrampResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct MistyswapOnramp_Onramp: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var params: MistyswapOnramp_OnrampParams {
    get {_storage._params ?? MistyswapOnramp_OnrampParams()}
...
public struct MistyswapOnramp_GetOnrampStatusRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct MistyswapOnramp_GetOnrampStatusResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var onramp: MistyswapOnramp_Onramp {
    get {_onramp ?? MistyswapOnramp_Onramp()}
    set {_onramp = newValue}
  }
  /// Returns true if `onramp` has been explicitly set.
  public var hasOnramp: Bool {self._onramp != nil}
...
public struct MistyswapOnramp_GetOnrampDebugInfoRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct MistyswapOnramp_GetOnrampDebugInfoResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension MistyswapOnramp_OnrampResultCode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ORC_INVALID\0\u{1}ORC_OK\0\u{1}ORC_TOO_MANY_ONRAMPS\0\u{1}ORC_MIXIN_CREDENTIALS_JSON\0\u{1}ORC_CREDENTIALS_ALREADY_IN_USE\0\u{1}ORC_MIXIN\0\u{1}ORC_ONRAMP_NOT_FOUND\0\u{1}ORC_INVALID_SRC_ASSET_ID\0\u{1}ORC_INVALID_DST_ASSET_ID\0\u{1}ORC_INVALID_WITHDRAWAL_ADDRESS\0\u{1}ORC_INVALID_MIN_WITHDRAWAL_AMOUNT\0\u{1}ORC_INVALID_MIN_SWAP_RATE\0")
}

extension MistyswapOnramp_OnrampState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0OS_INVALID\0\u{1}OS_NOT_STARTED\0\u{1}OS_POLLING\0\u{1}OS_WAITING\0\u{1}OS_INTERMITTENT_ERROR\0\u{1}OS_BLOCKED_ON_SWAP\0\u{1}OS_BLOCKED_ON_WITHDRAWAL\0")
}
...
extension MistyswapOnramp_OnrampResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}code\0\u{1}message\0\u{3}onramp_id\0\u{3}asset_id\0")
...
extension MistyswapOnramp_OnrampParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}dst_asset_id\0\u{3}src_asset_id_to_min_swap_rate\0\u{3}dst_address\0\u{3}min_withdrawal_amount\0")
...
extension MistyswapOnramp_SetupOnrampResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}result\0\u{3}onramp_id\0")
...
extension MistyswapOnramp_ForgetOnrampRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}onramp_id\0")
...
extension MistyswapOnramp_GetOnrampStatusResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}result\0\u{1}onramp\0")
