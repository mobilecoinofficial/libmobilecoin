...
public struct FogView_TxOutRecordLegacy: Sendable {
...
extension FogView_TxOutRecordLegacy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}tx_out_amount_commitment_data\0\u{3}tx_out_amount_masked_value\0\u{3}tx_out_target_key_data\0\u{3}tx_out_public_key_data\0\u{3}tx_out_global_index\0\u{3}block_index\0\u{1}timestamp\0\u{3}tx_out_amount_commitment_data_crc32\0\u{3}tx_out_e_memo_data\0\u{3}tx_out_amount_masked_token_id\0")
