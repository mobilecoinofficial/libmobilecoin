...
public enum External_KnownTokenId: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public struct External_RistrettoPrivate: Sendable {
...
public struct External_CompressedRistretto: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_Ed25519Public: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_Ed25519Signature: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_Ed25519MultiSig: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_Ed25519SignerSet: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_AccountKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var viewPrivateKey: External_RistrettoPrivate {
    get {_viewPrivateKey ?? External_RistrettoPrivate()}
    set {_viewPrivateKey = newValue}
  }
  /// Returns true if `viewPrivateKey` has been explicitly set.
  public var hasViewPrivateKey: Bool {self._viewPrivateKey != nil}
  ...
  public var spendPrivateKey: External_RistrettoPrivate {
    get {_spendPrivateKey ?? External_RistrettoPrivate()}
    set {_spendPrivateKey = newValue}
  }
  /// Returns true if `spendPrivateKey` has been explicitly set.
  public var hasSpendPrivateKey: Bool {self._spendPrivateKey != nil}
...
public struct External_PublicAddress: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasViewPublicKey: Bool {self._viewPublicKey != nil}
  ...
  public var hasSpendPublicKey: Bool {self._spendPublicKey != nil}
...
public struct External_RootIdentity: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var rootEntropy: External_RootEntropy {
    get {_rootEntropy ?? External_RootEntropy()}
    set {_rootEntropy = newValue}
  }
  /// Returns true if `rootEntropy` has been explicitly set.
  public var hasRootEntropy: Bool {self._rootEntropy != nil}
...
public struct External_RootEntropy: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_CurveScalar: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_KeyImage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_Range: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_TxOutMembershipHash: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_TxOutMembershipElement: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var range: External_Range {
    get {_range ?? External_Range()}
    set {_range = newValue}
  }
  ...
  public var hash: External_TxOutMembershipHash {
    get {_hash ?? External_TxOutMembershipHash()}
    set {_hash = newValue}
  }
...
public struct External_TxOutMembershipProof: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_TxOutConfirmationNumber: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// MaskedAmount.
public struct External_MaskedAmount: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasCommitment: Bool {self._commitment != nil}
...
public struct External_EncryptedFogHint: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_EncryptedMemo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_TxOut: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var targetKey: External_CompressedRistretto {
    get {_targetKey ?? External_CompressedRistretto()}
  ...
  public var eFogHint: External_EncryptedFogHint {
    get {_eFogHint ?? External_EncryptedFogHint()}
    set {_eFogHint = newValue}
  }
  /// Returns true if `eFogHint` has been explicitly set.
  public var hasEFogHint: Bool {self._eFogHint != nil}
  ...
  public var eMemo: External_EncryptedMemo {
    get {_eMemo ?? External_EncryptedMemo()}
    set {_eMemo = newValue}
  }
  /// Returns true if `eMemo` has been explicitly set.
  public var hasEMemo: Bool {self._eMemo != nil}
  ...
  /// For v1, the TxOut shared secret is used directly.
  /// For v2, an intermediate secret called amount shared secret is used.
  public enum OneOf_MaskedAmount: Equatable, Sendable {
...
public struct External_TxIn: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var inputRules: External_InputRules {
    get {_inputRules ?? External_InputRules()}
    set {_inputRules = newValue}
  }
  /// Returns true if `inputRules` has been explicitly set.
  public var hasInputRules: Bool {self._inputRules != nil}
...
public struct External_InputRules: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var partialFillChange: External_RevealedTxOut {
    get {_partialFillChange ?? External_RevealedTxOut()}
    set {_partialFillChange = newValue}
  }
  /// Returns true if `partialFillChange` has been explicitly set.
  public var hasPartialFillChange: Bool {self._partialFillChange != nil}
...
public struct External_RevealedTxOut: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var txOut: External_TxOut {
    get {_txOut ?? External_TxOut()}
    set {_txOut = newValue}
  }
  /// Returns true if `txOut` has been explicitly set.
  public var hasTxOut: Bool {self._txOut != nil}
...
public struct External_TxPrefix: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_RingMLSAG: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var cZero: External_CurveScalar {
    get {_cZero ?? External_CurveScalar()}
    set {_cZero = newValue}
  }
  /// Returns true if `cZero` has been explicitly set.
  public var hasCZero: Bool {self._cZero != nil}
  ...
  public var keyImage: External_KeyImage {
    get {_keyImage ?? External_KeyImage()}
    set {_keyImage = newValue}
  }
  /// Returns true if `keyImage` has been explicitly set.
  public var hasKeyImage: Bool {self._keyImage != nil}
...
public struct External_SignatureRctBulletproofs: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_Tx: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var signature: External_SignatureRctBulletproofs {
    get {_signature ?? External_SignatureRctBulletproofs()}
...
public struct External_TxHash: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_Receipt: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasConfirmation: Bool {self._confirmation != nil}
...
public struct External_VerificationSignature: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_VerificationReport: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var sig: External_VerificationSignature {
    get {_sig ?? External_VerificationSignature()}
    set {_sig = newValue}
  }
  /// Returns true if `sig` has been explicitly set.
  public var hasSig: Bool {self._sig != nil}
...
public struct External_Quote3: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// This is type is used in block chain types and should not have fields removed.
/// New fields can be added, but will be assumed optional by consumers
public struct External_Collateral: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// This is type is used in block chain types and should not have fields removed.
/// New fields can be added, but will be assumed optional by consumers
public struct External_EnclaveReportDataContents: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// This is type is used in block chain types and should not have fields removed.
/// New fields can be added, but will be assumed optional by consumers
public struct External_DcapEvidence: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var quote: External_Quote3 {
    get {_quote ?? External_Quote3()}
    set {_quote = newValue}
  }
  /// Returns true if `quote` has been explicitly set.
  public var hasQuote: Bool {self._quote != nil}
  ...
  public var collateral: External_Collateral {
    get {_collateral ?? External_Collateral()}
  ...
  public var reportData: External_EnclaveReportDataContents {
    get {_reportData ?? External_EnclaveReportDataContents()}
    set {_reportData = newValue}
  }
  /// Returns true if `reportData` has been explicitly set.
  public var hasReportData: Bool {self._reportData != nil}
...
public struct External_MintTxPrefix: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_MintTx: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var prefix: External_MintTxPrefix {
    get {_prefix ?? External_MintTxPrefix()}
    set {_prefix = newValue}
  }
  /// Returns true if `prefix` has been explicitly set.
  public var hasPrefix: Bool {self._prefix != nil}
  ...
  public var signature: External_Ed25519MultiSig {
    get {_signature ?? External_Ed25519MultiSig()}
    set {_signature = newValue}
  }
  /// Returns true if `signature` has been explicitly set.
  public var hasSignature: Bool {self._signature != nil}
...
public struct External_MintConfig: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var signerSet: External_Ed25519SignerSet {
    get {_signerSet ?? External_Ed25519SignerSet()}
    set {_signerSet = newValue}
  }
  /// Returns true if `signerSet` has been explicitly set.
  public var hasSignerSet: Bool {self._signerSet != nil}
...
public struct External_MintConfigTxPrefix: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_MintConfigTx: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var prefix: External_MintConfigTxPrefix {
    get {_prefix ?? External_MintConfigTxPrefix()}
    set {_prefix = newValue}
  }
  /// Returns true if `prefix` has been explicitly set.
  public var hasPrefix: Bool {self._prefix != nil}
...
public struct External_ValidatedMintConfigTx: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var mintConfigTx: External_MintConfigTx {
    get {_mintConfigTx ?? External_MintConfigTx()}
    set {_mintConfigTx = newValue}
  }
  /// Returns true if `mintConfigTx` has been explicitly set.
  public var hasMintConfigTx: Bool {self._mintConfigTx != nil}
...
public struct External_UnmaskedAmount: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var blinding: External_CurveScalar {
    get {_blinding ?? External_CurveScalar()}
    set {_blinding = newValue}
  }
  /// Returns true if `blinding` has been explicitly set.
  public var hasBlinding: Bool {self._blinding != nil}
...
public struct External_SignedContingentInput: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var mlsag: External_RingMLSAG {
    get {_storage._mlsag ?? External_RingMLSAG()}
    set {_uniqueStorage()._mlsag = newValue}
  }
  /// Returns true if `mlsag` has been explicitly set.
  public var hasMlsag: Bool {_storage._mlsag != nil}
  ...
  public var pseudoOutputAmount: External_UnmaskedAmount {
    get {_storage._pseudoOutputAmount ?? External_UnmaskedAmount()}
    set {_uniqueStorage()._pseudoOutputAmount = newValue}
  }
  /// Returns true if `pseudoOutputAmount` has been explicitly set.
  public var hasPseudoOutputAmount: Bool {_storage._pseudoOutputAmount != nil}
  ...
  public var requiredOutputAmounts: [External_UnmaskedAmount] {
    get {_storage._requiredOutputAmounts}
  ...
  public var txOutGlobalIndices: [UInt64] {
    get {_storage._txOutGlobalIndices}
...
public struct External_Amount: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
//// creation of
public struct External_OutputSecret: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
//// an input
public struct External_InputSecret: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  //// Represents either the one-time private key, or data to derive it
  public enum OneOf_OnetimeKeyDeriveData: Equatable, Sendable {
...
public struct External_ReducedTxOut: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct External_SignableInputRing: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var inputSecret: External_InputSecret {
    get {_inputSecret ?? External_InputSecret()}
    set {_inputSecret = newValue}
  }
  /// Returns true if `inputSecret` has been explicitly set.
  public var hasInputSecret: Bool {self._inputSecret != nil}
...
//// signature
public struct External_PresignedInputRing: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var mlsag: External_RingMLSAG {
    get {_mlsag ?? External_RingMLSAG()}
    set {_mlsag = newValue}
  }
  /// Returns true if `mlsag` has been explicitly set.
  public var hasMlsag: Bool {self._mlsag != nil}
  /// Clears the value of `mlsag`. Subsequent reads from it will return its default value.
  ...
  public var pseudoOutputSecret: External_OutputSecret {
    get {_pseudoOutputSecret ?? External_OutputSecret()}
    set {_pseudoOutputSecret = newValue}
  }
  /// Returns true if `pseudoOutputSecret` has been explicitly set.
  public var hasPseudoOutputSecret: Bool {self._pseudoOutputSecret != nil}
...
public struct External_InputRing: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_Ring: Equatable, Sendable {
...
public struct External_UnsignedTx: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var txPrefix: External_TxPrefix {
    get {_txPrefix ?? External_TxPrefix()}
    set {_txPrefix = newValue}
  }
  /// Returns true if `txPrefix` has been explicitly set.
  public var hasTxPrefix: Bool {self._txPrefix != nil}
...
public struct External_TxOutSummaryUnblindingData: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var unmaskedAmount: External_UnmaskedAmount {
    get {_unmaskedAmount ?? External_UnmaskedAmount()}
    set {_unmaskedAmount = newValue}
  }
  /// Returns true if `unmaskedAmount` has been explicitly set.
  public var hasUnmaskedAmount: Bool {self._unmaskedAmount != nil}
  ...
  public var address: External_PublicAddress {
    get {_address ?? External_PublicAddress()}
  ...
  public var txPrivateKey: External_RistrettoPrivate {
    get {_txPrivateKey ?? External_RistrettoPrivate()}
    set {_txPrivateKey = newValue}
  }
  /// Returns true if `txPrivateKey` has been explicitly set.
  public var hasTxPrivateKey: Bool {self._txPrivateKey != nil}
...
public struct External_SigningData: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension External_KnownTokenId: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0MOB\0")
}
...
extension External_Ed25519SignerSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}individual_signers\0\u{1}threshold\0\u{3}multi_signers\0")
...
extension External_AccountKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}view_private_key\0\u{3}spend_private_key\0\u{3}fog_report_url\0\u{3}fog_report_id\0\u{3}fog_authority_spki\0")
...
extension External_PublicAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}view_public_key\0\u{3}spend_public_key\0\u{3}fog_report_url\0\u{3}fog_report_id\0\u{3}fog_authority_sig\0")
...
extension External_RootIdentity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}root_entropy\0\u{3}fog_report_url\0\u{3}fog_report_id\0\u{4}\u{2}fog_authority_spki\0")
...
extension External_TxOutMembershipElement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}range\0\u{1}hash\0")
...
extension External_TxOutMembershipProof: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}index\0\u{3}highest_index\0\u{1}elements\0")
...
extension External_MaskedAmount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}commitment\0\u{3}masked_value\0\u{3}masked_token_id\0")
...
extension External_TxOut: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}masked_amount_v1\0\u{3}target_key\0\u{3}public_key\0\u{3}e_fog_hint\0\u{3}e_memo\0\u{3}masked_amount_v2\0")
...
extension External_TxIn: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}ring\0\u{1}proofs\0\u{3}input_rules\0")
...
extension External_InputRules: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}required_outputs\0\u{3}max_tombstone_block\0\u{3}partial_fill_outputs\0\u{3}partial_fill_change\0\u{3}min_partial_fill_value\0")
...
extension External_RevealedTxOut: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}tx_out\0\u{3}amount_shared_secret\0")
...
extension External_TxPrefix: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}inputs\0\u{1}outputs\0\u{1}fee\0\u{3}tombstone_block\0\u{3}fee_token_id\0")
...
extension External_RingMLSAG: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}c_zero\0\u{1}responses\0\u{3}key_image\0")
...
extension External_SignatureRctBulletproofs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}ring_signatures\0\u{3}pseudo_output_commitments\0\u{3}range_proof_bytes\0\u{3}range_proofs\0\u{3}pseudo_output_token_ids\0\u{3}output_token_ids\0")
...
extension External_Tx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}prefix\0\u{1}signature\0\u{3}fee_map_digest\0")
...
extension External_Receipt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}public_key\0\u{1}confirmation\0\u{3}tombstone_block\0\u{3}masked_amount_v1\0\u{3}masked_amount_v2\0")
...
extension External_VerificationReport: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}sig\0\u{1}chain\0\u{3}http_body\0")
...
extension External_Collateral: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}pck_crl_issuer_chain\0\u{3}root_ca_crl\0\u{3}pck_crl\0\u{3}tcb_info_issuer_chain\0\u{3}tcb_info\0\u{3}qe_identity_issuer_chain\0\u{3}qe_identity\0")
...
extension External_EnclaveReportDataContents: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}nonce\0\u{1}key\0\u{3}custom_identity\0")
...
extension External_DcapEvidence: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}quote\0\u{1}collateral\0\u{3}report_data\0")
...
extension External_MintTxPrefix: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}token_id\0\u{1}amount\0\u{3}view_public_key\0\u{3}spend_public_key\0\u{1}nonce\0\u{3}tombstone_block\0\u{3}e_fog_hint\0")
...
extension External_MintTx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}prefix\0\u{1}signature\0")
...
extension External_MintConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}token_id\0\u{3}signer_set\0\u{3}mint_limit\0")
...
extension External_MintConfigTxPrefix: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}token_id\0\u{1}configs\0\u{1}nonce\0\u{3}tombstone_block\0\u{3}total_mint_limit\0")
...
extension External_ValidatedMintConfigTx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}mint_config_tx\0\u{3}signer_set\0")
...
extension External_UnmaskedAmount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}value\0\u{3}token_id\0\u{1}blinding\0")
...
extension External_SignedContingentInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}block_version\0\u{3}tx_in\0\u{1}mlsag\0\u{3}pseudo_output_amount\0\u{3}required_output_amounts\0\u{3}tx_out_global_indices\0")
...
extension External_Amount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}value\0\u{3}token_id\0")
...
extension External_OutputSecret: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}amount\0\u{1}blinding\0")
...
extension External_InputSecret: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}onetime_private_key\0\u{3}subaddress_index\0\u{1}amount\0\u{1}blinding\0")
...
extension External_ReducedTxOut: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}public_key\0\u{3}target_key\0\u{1}commitment\0")
...
extension External_SignableInputRing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}members\0\u{3}real_input_index\0\u{3}input_secret\0")
...
extension External_PresignedInputRing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}mlsag\0\u{3}pseudo_output_secret\0")
...
extension External_InputRing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}signable\0\u{1}presigned\0")
...
extension External_UnsignedTx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}tx_prefix\0\u{1}rings\0\u{4}\u{2}block_version\0\u{3}tx_out_unblinding_data\0")
...
extension External_TxOutSummaryUnblindingData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}unmasked_amount\0\u{1}address\0\u{3}tx_private_key\0")
...
extension External_SigningData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}mlsag_signing_digest\0\u{3}pseudo_output_blindings\0\u{3}pseudo_output_commitments\0\u{3}range_proof_bytes\0\u{3}range_proofs\0\u{3}pseudo_output_token_ids\0\u{3}output_token_ids\0")
