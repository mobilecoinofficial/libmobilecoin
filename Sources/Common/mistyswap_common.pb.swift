...
//// On-going swap info.
public struct MistyswapCommon_OngoingSwap: Sendable {
...
public struct MistyswapCommon_GetInfoResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension MistyswapCommon_OngoingSwap: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}trace_id\0\u{3}follow_id\0\u{3}src_asset_id\0\u{3}src_amount\0\u{3}dst_asset_id\0\u{3}dst_amount_min\0\u{3}route_hash_ids\0\u{3}transfer_json\0\u{3}pre_swap_src_balance\0\u{3}pre_swap_dst_balance\0")
...
extension MistyswapCommon_GetInfoResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}max_concurrent_offramps\0\u{3}max_concurrent_onramps\0\u{3}current_offramps\0\u{3}current_onramps\0\u{3}offramp_allowed_src_asset_ids\0\u{3}offramp_allowed_dst_asset_ids\0\u{3}onramp_allowed_src_asset_ids\0\u{3}onramp_allowed_dst_asset_ids\0")
